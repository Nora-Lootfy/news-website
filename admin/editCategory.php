...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    try {
        ...
        $sql = "UPDATE `news_db`.`category` SET `category`=? WHERE `id`=?";
...
//        echo "updated successfully";
        ...
        echo "Error in post handling editCategory.php: " . $e->getMessage();
    }
    ...
    try {
        ...
        $sql = "SELECT * FROM `news_db`.`category` WHERE id = ?";
        $stmt = $conn->prepare($sql);
        $stmt->execute([$id]);
        ...
        echo "Error in get handling editCategory.php: " . $e->getMessage();
    }
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="POST">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<button class="btn btn-primary" type="button" onclick="window.location='categories.php';">Cancel</button>
